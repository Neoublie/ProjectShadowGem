...
public class psTile_Grindstone extends LockableLootTileEntity  {

	public static int slots = 1;
	protected NonNullList<ItemStack> items = NonNullList.withSize(slots, ItemStack.EMPTY);
	
	public psTile_Grindstone(TileEntityType<?> tileEntityTypeIn) {
		super(tileEntityTypeIn);
	}
	
	public psTile_Grindstone() {
		this(TileEntityTypeInit.GRINDSTONE_TILE_ENTITY_TYPE.get());
	}
	...
	protected Container createMenu(int id, PlayerInventory player) {
		return new psContainer_Grindstone(id, player, this);
	}
